SURVEY_QUESTION_MAPPER = {
    ...
    '15.e. Are the choirs or vocal ensembles run by the school/teachers OR external providers that come into the school? (Tick all that apply.)': '15e_choir_vocal_ensembles_internal_external',
    ...
    '15.f. Are the dance groups run by the school/teachers OR external providers that come into the school? (Tick all that apply.)': '15f_dance_groups_internal_external',
    ...
    '15.g. Are the drama groups run by the school/teachers OR external providers that come into the school? (Tick all that apply.)': '15g_drama_groups_internal_external',
    ...
    '15.h. Are the D&T groups run by the school/teachers OR external providers that come into the school? (Tick all that apply.)': '15h_dt_groups_internal_external',
    ...
    '15.i. Are the digital media groups run by the school/teachers OR external providers that come into the school? (Tick all that apply.)': '15i_digital_media_internal_external',
    ...
    '15.j. Are the art groups run by the school/teachers OR external providers that come into the school? (Tick all that apply.)': '15j_art_groups_internal_external',
    ...
    "19.a. Typically, how are your school's arts trips funded? (Tick all that apply.)": '19a_arts_trips_funding',
    ...
    '20. Which of the following did you undertake in academic year 2022/23? (Tick all that apply.)': '20_trips_undertaken_22_23',
    '20.a. If you selected Other art trips, please specify:': '20a_arts_trips_other_details',
    '20.b. Were these theatre trips to see a play or musical to locationsâ€¦ (Tick all that apply.)': '20b_theatre_trip_locations', 
    '20.b.i. Which Key Stage(s) took part in these theatre trips? (Tick all that apply.)': '20bi_theatre_trip_key_stages', 
    '20.c. Were these concert trips to locationsâ€¦ (Tick all that apply.)': '20c_concert_trip_locations',
    '20.c.i. Which Key Stage(s) took part in these concert trips? (Tick all that apply.)': '20ci_concert_trip_key_stages',
    '20.d. Were these cinema trips to locationsâ€¦ (Tick all that apply.)': '20d_cinema_trip_locations',
    '20.d.i. Which Key Stage(s) took part in these cinema trips? (Tick all that apply.)': '20di_cinema_trip_key_stages',
    '20.e. Were these gallery trips to locationsâ€¦ (Tick all that apply.)': '20e_gallery_trip_locations',
    '20.e.i. Which Key Stage(s) took part in these gallery trips? (Tick all that apply.)': '20ei_gallery_trip_key_stages',
    '20.f. Were these dance trips to locationsâ€¦ (Tick all that apply.)': '20f_dance_trip_locations', 
    '20.f.i. Which Key Stage(s) took part in these dance trips? (Tick all that apply.)': '20fi_dance_trip_key_stages',
    '20.g. Were these museum trips to locationsâ€¦ (Tick all that apply.)': '20g_museum_trip_locations',
    '20.g.i. Which Key Stage(s) took part in these museum trips? (Tick all that apply.)': '20gi_museum_trip_key_stages',
    '20.h. Were these heritage site trips to locationsâ€¦ (Tick all that apply.)': '20h_heritage_trip_locations',
    '20.h.i. Which Key Stage(s) took part in these heritage site trips? (Tick all that apply.)': '20hi_heritage_trip_key_stages',
    '20.i. Were these gaming experience trips to locationsâ€¦ (Tick all that apply.)': '20i_gaming_trip_locations',
    '20.i.i. Which Key Stage(s) took part in these gaming experience trips? (Tick all that apply.)': '20ii_gaming_trip_key_stages',
    '20.j. Were these library trips to locationsâ€¦ (Tick all that apply.)': '20j_library_trip_locations',
    '20.j.i. Which Key Stage(s) took part in these library trips? (Tick all that apply.)': '20ji_library_trip_key_stages',
    '20.k. Were these community trips to locationsâ€¦ (Tick all that apply.)': '20k_community_trip_locations',
    '20.k.i. Which Key Stage(s) took part in these local community trips? (Tick all that apply.)': '20ki_community_trip_key_stages',
    '21. Regarding access, diversity, and inclusion â€“ does your school experience any barriers or challenges in encouraging, recruiting, or gaining permissions for pupils to go on trips out of school?': '21_barriers_encouraging_recruiting_permissions_trips',
    ...
    '22. Regarding access, diversity, and inclusion â€“ does your school experience any barriers or challenges with the experience or facilities at host venues when taking pupils on trips out of the school?': '22_barriers_facilities_host_venues_trips',
    '22.a. Please briefly describe the barriers or challenges you face.': '22a_barriers_facilities_host_venues_trips_details',
    '23. Is your school part of any national programmes delivered by arts institutions or organisations? (E.g., RSC Shakespeare in Schools, LAMDA etc.)': '23_national_programmes',
    '23.a. What national programmes does your school take part in?': '23a_national_programmes_details',
    '24. Does your school have a partnership with any local arts organisations, i.e. a relationship with an organisation that the school has worked with over a number of years?': '24_partnerships_external_orgs',
    ...
    '27. Are there any other arts programmes or projects your school has been a part of that you havenâ€™t mentioned yet?': '27_other_arts_programmes_partnerships',
    ...
    '29. Does your school give pupils opportunities to engage with professionals or practitioners in the arts? (E.g., musicians or artists-in-residence)': '29_pupil_practitioner_engagement_opportunities',
    ...
    '30.a. Please specify the role they have in your school. (E.g., careers advisor or external careers support.)': '30a_specialist_creative_career_advice_details',
    ...
    '32. Does your school support teachersâ€™ CPD in arts subjects? (E.g., as part of INSET days, external training courses.)': '32_supporting_teacher_cpd',
    '32.a. What support does your school offer?': '32a_supporting_teacher_cpd_details',
    '33. Do you consider your school to lack any particular areas of expertise in delivering the arts curriculum? (Answers will be anonymised and data will not be linked to individual schools.)': '33_school_lacking_expertise_arts_curriculum',
